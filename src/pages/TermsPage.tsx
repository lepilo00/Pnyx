  ...
  return (
    <Layout>
      <div className="space-y-6 text-stone-700">
        <div>
          <h1 className="font-serif text-3xl font-bold text-stone-900 mb-1">Terms of Use</h1>
          <p className="text-sm text-stone-400">Last updated: June 2025</p>
        </div>

        <section className="space-y-2">
          <h2 className="font-semibold text-stone-800 text-lg">1. Nature of this service</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-stone-800 text-lg">2. Visitor responsibility</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-stone-800 text-lg">3. Accuracy of content</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-stone-800 text-lg">4. Limitation of liability</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-stone-800 text-lg">5. Intellectual property</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-stone-800 text-lg">6. Changes to terms</h2>
          <p className="text-sm leading-relaxed">
